  ...
  return (
    <div>
      ...
      <div className="lg:mx-32 mx-8">
        <div className="mx-auto flex lg:px-32 px-5 py-16 md:flex-row flex-col items-center bg-cover bg-center bg-opacity-70 bg-[url('/images/bg-event.png')] rounded-2xl">
          <div className="lg:max-w-lg lg:w-full md:w-1/2 w-5/6 mb-10 md:mb-0">
            <Image
              className="rounded-lg"
              src="/images/dummy-village.jpg"
              width={1000}
              height={1000}
              alt=""
            />
